	...
	<!-- start slider -->
       <div id="fwslider">
         <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
               <img src="{{ asset('assets/images/slider1.jpg') }}" class="img-responsive" alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
            ...
            <div class="slide">
               <img src="{{ asset('assets/images/slider2.jpt') }}" class="img-responsive" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h1 class="title">Run Over<br>Everything</h1>
                       	<div class="button"><a href="#">See Details</a></div>
	  ...
	  <div class="main">
		<div class="content-top">
			...
			<div class="close_but"><i class="close1"> </i></div>
				<ul id="flexiselDemo3">
				<li><img src="{{ asset('assets/images/board1.jpg') }}" /></li>
				<li><img src="{{ asset('assets/images/board2.jpg') }}" /></li>
				<li><img src="{{ asset('assets/images/board3.jpg') }}" /></li>
				<li><img src="{{ asset('assets/images/board4.jpg') }}" /></li>
				<li><img src="{{ asset('assets/images/board5.jpg') }}" /></li>
			</ul>
			...
			<div class="close_but"><i class="close1"> </i></div>
			  <div class="row">
				...
				<div class="col-md-3 top_box1">
					<div class="view view-ninth"><a href="single.html">
                    <img src="{{ asset('assets/images/pic4.jpg') }}" class="img-responsive" alt=""/>
                    <div class="mask mask-1"> </div>
                    <div class="mask mask-2"> </div>
                      <div class="content">
                        <h2>Hover Style #9</h2>
