              ...
              <div class="col-md-9 single_left">
                 <div class="single_image">
                       <ul id="etalage">
                          <li>
                              <a href="#">
                                  <img class="etalage_thumb_image" src="{{ asset('assets/images/3.jpg') }}" />
                                  <img class="etalage_source_image" src="{{ asset('assets/images/3.jpg') }}" />
                              </a>
                          </li>
                          <li>
                              <img class="etalage_thumb_image" src="{{ asset('assets/images/4.jpg') }}" />
                              <img class="etalage_source_image" src="{{ asset('assets/images/4.jpg') }}" />
                          </li>
                          <li>
                              <img class="etalage_thumb_image" src="{{ asset('assets/images/5.jpg') }}" />
                              <img class="etalage_source_image" src="{{ asset('assets/images/5.jpg') }}" />
                          </li>
                          <li>
                              <img class="etalage_thumb_image" src="images/{{ asset('assets/images/6.jpg') }}" />
                              <img class="etalage_source_image" src="{{ asset('assets/images/6.jpg') }}" />
                          </li>
                          <li>
                              <img class="etalage_thumb_image" src="{{ asset('assets/images/7.jpg') }}" />
                              <img class="etalage_source_image" src="{{ asset('assets/images/7.jpg') }}" />
                          </li>
                          <li>
                              <img class="etalage_thumb_image" src="{{ asset('assets/images/8.jpg') }}" />
                              <img class="etalage_source_image" src="{{ asset('assets/images/8.jpg') }}" />
                          </li>
                          <li>
                              <img class="etalage_thumb_image" src="{{ asset('assets/images/9.jpg') }}" />
                              <img class="etalage_source_image" src="{{ asset('assets/images/9.jpg') }}" />
                          </li>
                      </ul>
                      </div>
                      <!-- end product_slider -->
          ...
          <div class="row">
              ...
              <div class="col-md-4 product1">
                  ...
                  <div class="shop_desc"><a href="single.html">
                      </a><h3><a href="{{ route('single') }}"></a><a href="#">aliquam volutp</a></h3>
